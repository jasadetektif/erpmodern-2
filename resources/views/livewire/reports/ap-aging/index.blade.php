    ...
    <div class="py-4">
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <div class="flex justify-between items-center mb-6">
                 <h2 class="text-xl font-semibold">{{ __('Accounts Payable Aging Summary') }}</h2>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-left ...">{{ __('Supplier') }}</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @forelse ($allInvoices as $invoice)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-right">Rp {{ number_format($invoice->total_amount, 2, ',', '.') }}</td>
                        ...
                        @empty
                            <tr><td colspan="5" class="px-6 py-4 text-center ...">{{ __('All supplier invoices are paid.') }}</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
